function tt = getTimeSeriesRevisions(provider, id, startTime, endTime, updatedAfter, includeHistory)  
    ...
    %try java code
    try
        result = javaMethod('getTimeSeriesTable', 'it.bancaditalia.oss.sdmx.client.SdmxClientHandler', provider, '', id, '', startTime, endTime, false, updatedAfter, includeHistory);
	catch mexp
